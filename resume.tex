...
\begin{document}
\name{Max Meinhold}
\tagline{Seeking Spring-Summer 2019 Co-op}
\personalinfo{%
...
\cvevent{Data Analyst}{Asexual Community Census}{August 2017 -- Current}{}
Assist in processing and analysis, survey design, and report creation for the annual Asexual Community Survey.

\divider

\cvevent{AV Responder}{Classroom Technology Support}{January 2018 -- Current}{Rochester Institute of Technology}
...
\cvevent{Intern}{Emergent Space Technologies}{June 2016 -- August 2016}{NASA Goddard Spaceflight Center}
...
\cvevent{Quotefault Slack Bot}{https://github.com/mxmeinhold/csh-quotefault-bot}{Summer 2018}{}
...
\cvevent{ThemeSwitcher}{https://github.com/mxmeinhold/CSHThemeSwitcher}{Spring 2018}{}
A service for saving a user's Bootstrap theme preference and applying it to internal CSH services.
Built using AngularJS and Bootstrap for front end and NodeJS Express for routing.

\divider

\cvevent{Scouting Scheduler}{https://github.com/mxmeinhold/ScoutingScheduler}{Spring 2016, Spring 2017}{}
